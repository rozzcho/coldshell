 ...
 * shows its picture, with the name, the server link, switching accounts and logging out behind it.
 */
export function DiscordButton() {
  ...
  if (!discord) {
    return (
      <a className="discord-button" href={DISCORD_LOGIN_URL} aria-label="Connect Discord" title="Connect Discord">
    ...
    <div className="discord-menu" ref={menuRef}>
      ...
      {open && (
        <div className="discord-dropdown">
          <p className="discord-who">{discord.username}</p>
